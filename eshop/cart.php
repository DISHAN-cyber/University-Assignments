    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                product.color_clr_id=color.clr_id INNER JOIN `user` ON 
                product.user_email=user.email INNER JOIN `product_img` ON cart.cart_product_id=product_img.product_id WHERE `cart_user_email`='" . $mail . "'");
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 emptyCart">
                                        <img src="resources/emptycart.svg" style="height: 500px; margin-left: 400px;">
                                    </div>
                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    for ($x = 0; $x < $cart_num; $x++) {
                                        ...
                                        $address_rs = Database::search("SELECT `district_id` FROM `user_has_address` 
                                    INNER JOIN `city` ON user_has_address.city_city_id=city.city_id INNER JOIN 
                                    `district` ON city.district_district_id=district.district_id WHERE
                                    `user_email`='" . $mail . "'");
                                            ...
                                            <div class="row g-0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <span class="fw-bold text-black fs-5">
                                                                <?php echo $cart_data["fname"]." ".$cart_data["lname"];?>
                                                            </span>&nbsp;
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus"
                                                        ...
                                                        <img src="<?php echo $cart_data["img_path"]; ?>" class="img-fluid rounded-start" style="max-width: 200px;">
                                                    </span>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black-50">Colour : <?php echo $cart_data["clr_name"]; ?></span> &nbsp; |
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black-50">
                                                                Rs.<?php echo ($cart_data["price"]*$cart_data["cart_qty"])+$ship; ?>.00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
