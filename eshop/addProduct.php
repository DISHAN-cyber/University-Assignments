                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4 border-end border-success">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select text-center" onchange="selectBrand();" id="category">
                            ...
                            <div class="col-12 col-lg-4 border-end border-success">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select text-center" onchange="selectModel();" id="brand">
                                ...
                                <div class="row">
                                    ...
                                    <div class="offset-lg-3 col-12 col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-4 border border-primary rounded">
                                                <img src="resources/addproductimg.svg" class="img-thumbnail" style="width: 250px;" id="i2" />
                                            </div>
                                        </div>
                                    </div>
