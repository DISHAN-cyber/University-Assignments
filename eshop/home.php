                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-12 mt-3 mb-3">
                            <a href="#" class="text-decoration-none text-dark fs-3 fw-bold"><?php echo $category_data2["cat_name"]; ?>
                            </a> &nbsp;&nbsp;
                                    ...
                                    <div class="row border border-primary">
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-center gap-2">
                                                ...
                                                $product_rs = Database::search("SELECT * FROM `product` WHERE
                                                `category_cat_id`='" . $category_data2["cat_id"] . "' AND `status_status_id`=1 
                                                        ...
                                                        <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                            ...
                                                            <div class="card-body ms-0 m-0 text-center">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <button class="col-12 btn btn-dark mt-2" onclick="addToCart('<?php echo $product_data['id']; ?>','<?php echo $product_data['qty']; ?>');">
                                                                ...
                                                                if (isset($_SESSION["u"])) {
                                                                    ...
                                                                    `user_email`='" . $_SESSION["u"]["email"] . "' AND 
                                                                    `product_id`='" . $product_data["id"] . "'");
                                                                ...
                                                                ?>
                                                                        <button onclick="addToWatchlist(<?php echo $product_data['id']; ?>);" class="col-12 btn btn-outline-light mt-2 border border-primary">
                                                                            <i id="heart<?php echo $product_data['id']; ?>" class="bi bi-heart-fill text-danger fs-5"></i>
                                                                        </button>
                                                                    <?php
                                                                    } else {
                                                                    ?>
                                                                        <button onclick="addToWatchlist(<?php echo $product_data['id']; ?>);" class="col-12 btn btn-outline-light mt-2 border border-primary">
                                                                            <i id="heart<?php echo $product_data['id']; ?>" class="bi bi-heart-fill text-dark fs-5"></i>
                                                                        </button>
                                                                <?php
                                                                    }
                                                                }
