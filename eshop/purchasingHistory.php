    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                invoice.product_id=product.id INNER JOIN `user` ON product.user_email=user.email
                WHERE `invoice`.`user_email`='" . $email . "'");
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button onclick="addFeedback(<?php echo $invoice_data['id']; ?>);" class="btn btn-secondary rounded border border-1 border-primary mt-5 fs-5">
