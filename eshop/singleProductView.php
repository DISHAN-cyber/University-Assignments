...
if (isset($_GET["id"])) {
    ...
    product.model_has_brand_model_has_brand_id=model_has_brand.model_has_brand_id INNER JOIN
    `brand` ON model_has_brand.brand_brand_id=brand.brand_id INNER JOIN `model` ON
                        ...
                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        ...
                                                        <span class="fs-5 text-primary"><b>In Stock : </b><?php echo $product_data["qty"]; ?> Items</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        <div class="row">
                                                            <div class="col-10 col-lg-4 border border-1 border-dark text-center py-2">
                                                                <span class="fs-5 text-primary"><b>Seller : </b><?php echo $product_data["fname"]; ?></span>
                                                            </div>
                                                            <div class="col-2 col-lg-2 border border-1 border-dark text-center d-grid">
                                                                <a href="messages.php?id=<?php echo $product_data['email']; ?>" class="btn btn-success">
                                                                    
                                                                    <i class="bi bi-chat-dots-fill text-white fw-bold h4 py-2"></i>
                                                                </a>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center py-2">
                            ...
                            <div class="col-12 bg-white">
                                <div class="row gap-2">
                                    ...
                                    `model_has_brand_model_has_brand_id`='" . $product_data["model_has_brand_model_has_brand_id"] . "
                                    LIMIT 5'");
                                    ...
                                    ?>
                                        <div class="offset-1 offset-lg-0 col-4 col-lg-2">
                                            <div class="card" style="width: 18rem;">
                                                <img src="<?php echo $img[$x]; ?>" class="card-img-top" />
                                                <div class="card-body">
                                                    <h5 class="card-title"><?php echo $related_data["title"] ?></h5>
                                                    <h6 class="card-text"><?php echo $related_data["price"] ?></h6>
                                                    <h6 class="card-text"><?php echo $related_data["qty"] ?> Items</h6>
