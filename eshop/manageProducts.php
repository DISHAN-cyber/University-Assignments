            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2"
                            onmouseenter="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            <?php
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="pb<?php echo $selected_data['id']; ?>"
                                    onclick="productBlock('<?php echo $selected_data['id']; ?>');"
                ...
                <!-- modal 01 -->
                <div class="modal" tabindex="-1" id="productModal<?php echo $selected_data['id']; ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="offset-4 col-4">
                                    <img src="<?php echo $img_data["img_path"]; ?>" class="img-fluid" style="height: 150px;" />
                                </div>
                                <div class="col-12">
