    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                watchlist.product_id=product.id INNER JOIN `color` ON product.color_clr_id=color.clr_id
                INNER JOIN `condition` ON product.condition_condition_id=condition.condition_id 
                INNER JOIN `user` ON watchlist.user_email=user.email WHERE 
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                <img src="resources/watchlistEmptyView.svg" style="height: 300px; margin-top: -400px; margin-left: 100px;">
                                                    ...
                                                    <div class="row g-0">
                                                        <div class="col-md-4">
                                                            ...
                                                            <img src="<?php echo $img_data["img_path"]; ?>"
                                                                class="img-fluid rounded-start" style="height: 180px;" />
                                                        </div>
                                                        <div class="col-md-5">
                                                            <div class="card-body">
                                                                ...
                                                                <br />
                                                                <span class="fs-5 fw-bold text-black"><?php echo $watchlist_data["fname"] ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mt-5">
                                                            <div class="card-body d-lg-grid">
                                                                ...
                                                                onclick="removeFromWatchlist(<?php echo $list_id; ?>);">Remove</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
