                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        ?>
                                            <img src="resources/new_user.svg" class="rounded mt-5" id="img" style="width: 150px;" />
                                        <?php
                                        } else {
                                        ?>
                                            <img src="<?php echo $image_data["img_path"]; ?>" class="rounded mt-5" id="img" style="width: 150px;" />
                                        <?php
                                        }
                                        ...
                                        <label for="profileImage" class="btn btn-primary mt-5" onclick="changeProfileImg();">Upload Profile Image</label>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                ?>
                                                    <input type="text" id="line2" class="form-control" placeholder="Type Address Line 02" />
                                                <?php
                                                } else {
                                                ?>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select class="form-select" onchange="selectCity();" id="district">
